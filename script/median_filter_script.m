...
[noisy_I, new_I] = median_filter(I, type, density, m, n);
...
figure; imshow(new_I); title('Citra Hasil MedianFilter');
figure; imhist(new_I); title('Histogram Citra Hasil MedianFilter');