...
Q = input('Masukkan Q: ', 's');
Q = str2double(Q);

if isnan(Q) || floor(Q) ~= Q
    error('Q tidak valid!');
else
    n = int32(n);
end
...
figure; imshow(new_I); title('Citra Hasil Penapis Rerata Kontraharmonik');
figure; imhist(new_I); title('Histogram Citra Hasil Penapis Rerata Kontraharmonik');