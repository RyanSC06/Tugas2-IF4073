...
[noisy_I, new_I] = midpoint_filter(I, type, density, m, n);
...
figure; imshow(new_I); title('Citra Hasil Penapis Rerata Midpoint');
figure; imhist(new_I); title('Histogram Citra Hasil Penapis Midpoint');