...
[noisy_I, new_I] = harmonic_mean_filter(I, type, density, m, n);
...
figure; imshow(new_I); title('Citra Hasil Penapis Rerata Harmonik');
figure; imhist(new_I); title('Histogram Citra Hasil Penapis Rerata Harmonik');